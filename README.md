...
K 트리구조 
server.js의 ' AVAILABLE_BROADCASTING_NUMBER ' 를 수정하여 자식 노드 수 설정 가능
## Playing Demo screen
<p align="center">
...
## 실행환경: "react": "^19.2.3" / "react-scripts": "5.0.1" / "typescript": "^4.9.5" / Node.js v22.17.1
1. env, peer_ts>App.tsx 주소 맞게 변경 HOST= 192.168.0.6
2. Terminal 2개 실행 후
